...
cl = LINETCR.LINE()
cl.login(token="EqESX1D7wpDEomsaxT62.T/UQKwNuh4JaPGysNhcrWG.oaSjvIo/8WSYoc9mEDiw1obQaKnaOH3Q/rPCnasCMyw=")
#cl.login(token='TOKEN_HERE')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
ki.login(token="EqeokZ0bF5FC0yjxO6M9.rqjdyY/0X/W1+gIDoHj+kq.WZS3+o0Q3nMHeb98rv2L+9Fce63/mAWrCDQaNw2II10=")
#ki.login(token='TOKEN_HERE')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
kk.login(token="EquEvjqCJw40WP6BTf56.NnLqMAw86i/3gMm5Ov36rG.fJagQ5uZFJ+KpKxFTF2RqRTUA8mCynMzPIiBFuP/MzY=")
#kk.login(token='TOKEN_HERE')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
kc.login(token="EqRtZwFChXoZWS4VTxR9.nt7dQNsC+CzMwxheApWSQq.qg9dy1A7C8PSOEPgGUabD2lVsGTKpCclSqhPg1kOVFk=")
#kc.login(token='TOKEN_HERE')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
kr.login(token="Eq8QIyYQH5hfIitsaZ43.v8m/Hb3O/Dp8v455S8h2mW.xAUuVi7NgDtxWiW65YxmAbWap74uLwYIGoIswskjGpE=")
#kr.login(token='TOKEN_HERE')
kr.loginResult()
print "Kr-Login Success\n"

k1 = LINETCR.LINE()
k1.login(token="EqBccLy4xWVuLhUR06H0.kD1S3cJvgyWhqTlojR830a.HK6ocqQhLm6Uul8Da4SW8cgDgNMJtYfRlGDQp4PNBRQ=")
#kr.login(token='TOKEN_HERE')
k1.loginResult()
print "Kr-Login Success\n"

k2 = LINETCR.LINE()
k2.login(token="EqMAtsL50BcQlWbWVNab.FDwGj7cW40QqNd+CaY9xwW.Fh9AUIQLH4n/K1qXq87NOSuAu0AgVWwgDqi/f2mUpKw=")
#kr.login(token='TOKEN_HERE')
k2.loginResult()
print "Kr-Login Success\n"

k3 = LINETCR.LINE()
k3.login(token="EqrkhJJnDXDUaDsIRIt3.9REh/b9d5j8kuVJKZwaniW.pv+90Lx2hrhu3Of2Mg6+q5C1/knK/cQ7EIXAgdxdXfU=")
#kr.login(token='TOKEN_HERE')
k3.loginResult()
print "Kr-Login Success\n"

k4 = LINETCR.LINE()
k4.login(token="Eq6tYLnQHV72N8M8jm57.fVjD3nSW3qxCeaTG+pxS1W.pXyqVMjedd4mc7J6OR1vN7U8XH2dgjokgmijsFg5AUY=")
#kr.login(token='TOKEN_HERE')
k4.loginResult()
print "Kr-Login Success\n"

k5 = LINETCR.LINE()
k5.login(token="Eqwm7IuDCroCQxgDDhX6.9FgyxXnwgoyffHJH+zvs9G.0vngnC+gdGUX81IfsmflxwH/RVWDfmHzGKmiGLTD29g=")
#kr.login(token='TOKEN_HERE')
k5.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
km.login(token="EqYhNFW0C2QEvxFUZvk4.uzrPTepo+2oCMBoGqnHf9a.pPf26qTyrgrphDQYsOuRQwGTMx2BAm/2cPwKeLLdZyw=")
...
KAC=[cl,ki,kk,kc,kr,k1,k2,k3,k4,k5]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
Bmid = kk.getProfile().mid
Cmid = kc.getProfile().mid
Dmid = kr.getProfile().mid
Fmid = k1.getProfile().mid
Gmid = k2.getProfile().mid
Hmid = k3.getProfile().mid
Imid = k4.getProfile().mid
Jmid = k5.getProfile().mid
Emid = km.getProfile().mid
Bots=[mid,Amid,Bmid,Cmid,Dmid,Fmid,Gmid,Hmid,Imid,Jmid,Emid]
Creator="u84e48a5112ea134eef91a0b5dabc86b6","u595b61f7e484cd4f5576b9ea4be6915b"
admin= ["u84e48a5112ea134eef91a0b5dabc86b6","u595b61f7e484cd4f5576b9ea4be6915b",mid,Amid,Bmid,Cmid,Dmid,Fmid,Gmid,Hmid,Imid,Jmid,Emid] 
...
responsename6 = k1.getProfile().displayName
responsename7 = k2.getProfile().displayName
responsename8 = k3.getProfile().displayName
responsename9 = k4.getProfile().displayName
responsename10 = k5.getProfile().displayName
...
wait = {
    ...
    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like ©By : ☄i̺͆y̺͆o̺͆😎",
    "comment7":"Kenapa Kak?",
    "comment8":"dasar jones ＼（○＾ω＾○）／",
    "comment9":"Alai dah!!! ヘ(^_^)ヘ",
    "comment6":"PreeeT..... (^_^)",
    "comment10":"Bot Auto Like ©By : ☄i̺͆y̺͆o̺͆😎 ",    
    "commentOn":True,
    "commentBlack":{},
    "message":"Thx For Add Me (^_^)\nkalo mau protect \nInvite Me To Your Group \ntapi seblumnya pm dlu bos aq \nid line: ri_her \nヘ(^_^)ヘ",    
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Qr":True,
...
#--------------------------------------------------------
	    if mid in op.param3:
			...
			cl.updateGroup(G)
			cl.sendText(op.param1,"TྂEྂRྂIྂMྂAྂKྂAྂSྂIྂHྂ SྂUྂDྂAྂHྂ MྂEྂMྂBྂEྂRྂIྂ KྂEྂPྂEྂRྂCྂAྂYྂAྂAྂNྂ KྂEྂPྂAྂDྂAྂ \nTྂEྂAྂMྂ KྂAྂMྂIྂ")
			cl.sendText(op.param1,"apa bila ada masalah..\n\nContact Me : http://line.me/ti/p/VxtJPseezK")
                else:
...
#----------------------------------------------------------------------------
            ...
            if wait["alwaysRead"] == True:
                if msg.toType == 0:
                    ...
                    k1.sendChatChecked(msg.from_,msg.id)
                    k2.sendChatChecked(msg.from_,msg.id)
                    k3.sendChatChecked(msg.from_,msg.id)
                    k4.sendChatChecked(msg.from_,msg.id)
                    k5.sendChatChecked(msg.from_,msg.id)                    
                else:
                    ...
                    k1.sendChatChecked(msg.to,msg.id)
                    k2.sendChatChecked(msg.to,msg.id)
                    k3.sendChatChecked(msg.to,msg.id)
                    k4.sendChatChecked(msg.to,msg.id)
                    k5.sendChatChecked(msg.to,msg.id)                    
        ...
        if op.type == 55:
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        cl.sendText(op.param1, "Haii " + "☞ " + nick[0] + " ☜" + "\nHanya Jones yg sering ngintip di room😂😝 ")
                                    else:
                                        cl.sendText(op.param1, "Haii " + "☞ " + nick[1] + " ☜" + "\nKoq nyimak aja.. Dicariin tuh sama tikungannya di room . .\nAwas Bintitan loh 😁😝 ")
                                else:
                                    cl.sendText(op.param1, "Haii " + "☞ " + Name + " ☜" + "\nNgapain Kak Ngintip Aja???\nLagi nyari target yah buat jadi tikungannya.. 😂 ")
                        else:
                            pass
                    else:
                        pass
            ...
            if msg.contentType == 16:
                if wait['likeOn'] == True:
                     ...
                     k1.like(url[25:58], url[66:], likeType=1005)
                     k2.like(url[25:58], url[66:], likeType=1002)
                     k3.like(url[25:58], url[66:], likeType=1004)
                     k4.like(url[25:58], url[66:], likeType=1003)
                     ...
                     k1.comment(url[25:58], url[66:], wait["comment6"])
                     k2.comment(url[25:58], url[66:], wait["comment7"])
                     k3.comment(url[25:58], url[66:], wait["comment8"])
                     k4.comment(url[25:58], url[66:], wait["comment9"])
                     k5.comment(url[25:58], url[66:], wait["comment10"])                     
...
#--------------------------------------------------------
		...
		gid = cl.getGroupIdsJoined()
			...
			k4.leaveGroup(i)
			k5.leaveGroup(i)
		    cl.sendText(msg.to,"Success Leave All Group Bos Q")
		else:
		    cl.sendText(msg.to,"Khusus admin")
#--------------------------------------------------------
...
#--------------------------------------------------------
		...
		if msg.from_ in Creator:
                    wait["Qr"] = True
                    cl.sendText(msg.to,"P͓̽r͓̽o͓̽t͓̽e͓̽c͓̽t͓̽ Q͓̽r͓̽ s͓̽u͓̽d͓̽a͓̽h͓̽ o͓̽n͓̽")
		else:
		    cl.sendText(msg.to,"Khusus admin")
		...
		if msg.from_ in Creator:
                    wait["Qr"] = False
                    cl.sendText(msg.to,"P͓̽r͓̽o͓̽t͓̽e͓̽c͓̽t͓̽ Q͓̽r͓̽ o͓̽f͓̽f͓̽ B͓̽o͓̽s͓̽ Q͓̽")
		else:
		    cl.sendText(msg.to,"Khusus admin")
#--------------------------------------------------------
...
#---------------------------------------------------------
		...
		if msg.from_ in Creator:
                    ...
                    wait["Sambutan"] = True
                    wait["Ghost"] = True                    
                    cl.sendText(msg.to,"Mode on sudah Aktif Semua \ny͓̽a͓̽n͓̽g͓̽ m͓̽a͓̽c͓̽e͓̽m͓̽- m͓̽a͓̽c͓̽e͓̽m͓̽ a͓̽k͓̽u͓̽ K̶I̶C̶K̶")
		else:
		    cl.sendText(msg.to,"Khusus admin")
...
#--------------------------------------------------------
            elif msg.text in ["Berhitung"]:
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"Assist 1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"Assist 2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"Assist 3 Hadiir  \(ˆ▿ˆ)/")
                k1.sendText(msg.to,"Assist 4 Hadiir  \(ˆ▿ˆ)/")
                k2.sendText(msg.to,"Assist 5 Hadiir  \(ˆ▿ˆ)/")
                k3.sendText(msg.to,"Assist 6 Hadiir  \(ˆ▿ˆ)/")
                k4.sendText(msg.to,"Assist 7 Hadiir  \(ˆ▿ˆ)/")
                k5.sendText(msg.to,"Assist 8 Hadiir  \(ˆ▿ˆ)/")                
                kr.sendText(msg.to,"Hadiir Semua Bos Q  \(ˆ▿ˆ)/")
                ...
                k1.sendText(msg.to,responsename6)
                k2.sendText(msg.to,responsename7)
                k3.sendText(msg.to,responsename8)
                k4.sendText(msg.to,responsename9)
                k5.sendText(msg.to,responsename10)                
#--------------------------------------------------------
            elif msg.text in ["P"]:
                start = time.time()
                print("Speed")                
...
#--------------------------------------------------------
		    ...
		    if msg.from_ in Creator:
				...
				if target not in admin:
                                    try:
                                        klist=[ki,kk,kc,kr,k1,k2,k3,k4,k5]
                                        kicker=random.choice(klist)
...
#--------------------------------------------------------
            ...
            elif "ASSIST copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("ASSIST copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = ki.getGroup(msg.to)
                   gs = kk.getGroup(msg.to)
                   gs = kc.getGroup(msg.to)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ...
                               ki.sendText(msg.to, "Succes Copied bos Q (^_^)")
                            except Exception as e:
                                print e
                ...
                try:
                    ...
                    k2.updateDisplayPicture(backup7.pictureStatus)
                    k2.updateProfile(backup7)

                    k3.updateDisplayPicture(backup8.pictureStatus)
                    k3.updateProfile(backup8)
                    
                    k4.updateDisplayPicture(backup9.pictureStatus)
                    k4.updateProfile(backup9)

                    k5.updateDisplayPicture(backup10.pictureStatus)
                    k5.updateProfile(backup10)                    

                    k1.updateDisplayPicture(backup6.pictureStatus)
                    k1.updateProfile(backup6)                    
...
#--------------------------------------------------------
            elif "@℘ąყ ႪlႩႽოႩტႶპ " in msg.text:
              if wait["Tag"] == True:
                tanya = msg.text.replace("@􀐂admin","")
                jawab = ("Jangan Tag Penting pc","Berisik Jangan Tag Si ℘ąყ ႪlႩႽოႩტႶპ,","Sekali lagi nge tag gw sumpahin jomblo seumur hidup!","Dia Lagi Sibuk Jangan Tag ☄℘ąყ ႪlႩႽოႩტႶპ","Woii Bicik Jangan Tag ☄℘ąყ ႪlႩႽოႩტႶპ Lagi Gua Bilang!!!","℘ąყ ႪlႩႽოႩტႶპ Lagi Off...\nKalau Penting PC Aja ℘ąყ ႪlႩႽოႩტႶპ nya")
