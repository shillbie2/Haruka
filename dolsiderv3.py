...
iyo = LINETCR.LINE()
iyo.login(token='EqjdS76a0tzUYjOAEmC6.5TQ8oyLsUDqtUalm0hNqnG.tp9XeLr3SU32qEw78ouwakatcTOQEH1QoHF9iTt1E7I=')
iyo.loginResult()
...
║         vibank = 130k
║====================
║syarat : untuk yg memakai
║ assist, siapkan akun
║linenya...
║======================
║untuk kegunaan, fiture dan 
║info lain lain nya  silahkan
║contact me :
...
Bots=[mid]
Creator=["u5baffcc81a0a0689982216a005cfc70b",mid]
admin=["u5baffcc81a0a0689982216a005cfc70b",mid]
#ainkCreator=["u8b2bb5214c1afc77d06901a535c23e30"]
#dnCreator=["u24535cc4cb6b79c9a6b764bf8d6a70a6"]
#dnadmin=["u24535cc4cb6b79c9a6b764bf8d6a70a6"]
#Ainkadmin=["u8b2bb5214c1afc77d06901a535c23e30","u49f93172b8c8865683dd2d47ccbb8613"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : ☄i̺͆y̺͆o̺͆😎\nContact Me : 👉 line.me/ti/pVxtJPseezk",    
    "commentOn":True,
    "commentBlack":{},
    "message":"Thx For Add Me (^_^) ☄i̺͆y̺͆o̺͆😎􀂳􏿿\nContact Me : 👉 line.me/ti/pVxtJPseezk",
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Qr":False,
    ...
    try:
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        iyo.sendText(op.param1, "eh.. ada " + "☞ " + nick[0] + " ☜" + "\nNgapain ngeliat doang....?😂   ")
                                    else:
                                        iyo.sendText(op.param1, "nih si" + "☞ " + nick[1] + " ☜" + "\nBetah Banget Jadi Penonton. . .\nsok polos...  ")
                                else:
                                    iyo.sendText(op.param1, "hayo ktawan... si " + "☞ " + Name + " ☜" + "\nNgapain Kak Ngintip Aja???\nSini Gabung Chat...\nbiar gk d bilang jones.. 😂🤣   ")
                        else:
                            pass
                    else:
                        pass
	    ...
	    if mid in op.param3:	        
		    ...
		    G = iyo.getGroup(op.param1)
                    if len(G.members) <= wait["Members"]:
                        iyo.acceptGroupInvitation(op.param1)
                        iyo.sendText(op.param1,"mohon Maaf " + iyo.getContact(op.param2).displayName + "\nMember Kurang Dari 20 Orang aku gak bisa join,\nUntuk Info, Silahkan Chat Owner Kami! \n\n         👉 line.me/ti/p/~ri_her 👈\n\n\n bye     " + iyo.getContact(op.param2).displayName + "\n      see you (~_^)")
                        iyo.leaveGroup(op.param1)                        
		    else:
                        iyo.acceptGroupInvitation(op.param1)
			iyo.sendText(op.param1,"matur thankyu wis undang aq...\nsalam kenal yo... \n ketik 'help' untuk bantuan.. \n Orasah sing neko² yo cok... \ngunakan bot ini dengan bijak.. ")
        ...
        if op.type == 15:
          if wait["Sambutan"] == True:
            ...
            #iyo.inviteIntoGroup(op.param1,[op.param2])
        ...
        if op.type == 26:
            ...
            if msg.text in ["Publik on"]:
              if msg.from_ in Creator:    
                wait["Bot"] = True
                iyo.sendText(msg.to,"Bote wis aktif neh bose.")   
        ...
        if op.type == 26:
          if wait["Bot"] == True:     
            ...
            if msg.contentType == 1:
                iyo.sendText(msg.to,"Foto apa si itu?")
            if msg.contentType == 3:
                iyo.sendText(msg.to, "Vn apa itu ?")
            if msg.contentType == 12:
                iyo.sendText(msg.to,"Link apaan itu ?")
            if msg.contentType == 14:
                iyo.sendText(msg.to,"Filenya auto download")                    
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = iyo.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Ngapain Tag!!" + cName + "\nKangen Pc za!!!!!","Dont Tag!! Lagi Sibuk",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","Tag Mulu Lo Anjirr!","Dia Lagi Off", cName + " Kenapa Tag? Kangen?","Dia Lagi Tidur\nJangan Di Tag " + cName, "Jangan Suka Tag Gua " + cName, "Ada Perlu Apa " + cName + "?","Woii " + cName + " Jangan Ngetag, Riibut!"]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
			...
			iyo.sendText(msg.to,"Admin Detected~")
                ...
                msg.contentMetadata = {'mid': "u9192d1ddd34164ffe5d08efba5ef1a57"}
                msg.contentMetadata = {'mid': "u246cb4d9c8a981d4299b7ef16cad49d9"}
                iyo.sendMessage(msg)
		iyo.sendText(msg.to,"iku loh bos q.. (^_^)")
		
            elif msg.text in ["help","Help"]:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "ub2f0433031c835c4ece33d5d6c63a685"}
                iyo.sendMessage(msg)
		iyo.sendText(msg.to,"wajib add ☝️")
		iyo.sendText(msg.to,"╔══════════════\n║┏━━ೋ•🌐•ೋ━━┓\n║❁  քʊɮʟɨċ ċօʍʍǟռɖ  ❁    \n║┗━━ೋ•🌐•ೋ━━┛\n╠══════════════\n║╔❂͜͡➣「Media」\n║╠❂͜͡➣「Translite」\n║╠❂͜͡➣「Sosmed」\n║╠❂͜͡➣「Kerang ajaib」\n║╠❂͜͡➣「Order (Bot & VPS)」\n║╠❂͜͡➣「Group publik」\n║╚❂͜͡➣「@pergi」\n╠══════════════\n║ᴮᵞ tɛǟʍɮօtǟʍǟtɨʀǟռ\n╚══════════════")
                msg.contentType = 13
                msg.contentMetadata = {'mid': "ub2f0433031c835c4ece33d5d6c63a685"}
                iyo.sendMessage(msg)
...
#                                print e
            ...
            elif msg.text in ["Keyo"]:
                iyo.sendText(msg.to,creatorMessage)

            elif msg.text in ["Group publik","group publik"]:
                iyo.sendText(msg.to,groupMessage)

            elif msg.text in ["Translite","translite"]:
                iyo.sendText(msg.to,helpTrans)

            elif msg.text in ["Kerang ajaib","kerang ajaib"]:
                iyo.sendText(msg.to,helpKerang)

            elif msg.text in ["sosmed","Sosmed"]:
                iyo.sendText(msg.to,helpSosmed)

            elif msg.text in ["Selfbot","selfbot"]:
                iyo.sendText(msg.to,helpSb)

            elif msg.text in ["media","Media"]:
                iyo.sendText(msg.to,mediaMessage)
                
            elif msg.text in ["Order","order"]:
                iyo.sendText(msg.to,helpOrder)                

            elif msg.text in ["Protect","protect"]:
                iyo.sendText(msg.to,helpProtect)                
		    ...
		    jml = 0
		        ...
		        gn = iyo.getGroup(i).name
                        #h +=
		        jml += 1
                    iyo.sendText(msg.to,"Bot ini sudah begabung\n\nSebanyak: "+str(jml))
		...
		if msg.from_ in Creator:
		    ...
		    iyo.sendText(msg.to, "Khusus ☄i̺͆y̺͆o̺͆😎")
		...
		if msg.from_ in Creator:
                    for i in gid:
                        h = iyo.getGroup(i).name
		        if h == ng:
			    iyo.sendText(i,"Bot kon metu, karo bose!")
		            iyo.leaveGroup(i)
		...
		if msg.from_ in Creator:
                    ...
                    iyo.sendText(msg.to,"Auto Respon Sudah Aktif")
		else:
		    iyo.sendText(msg.to,"Khusus ☄i̺͆y̺͆o̺͆😎")
		...
		if msg.from_ in Creator:
                    ...
                    iyo.sendText(msg.to,"Auto Respon Sudah Off")
		else:
		    iyo.sendText(msg.to,"Khusus ☄i̺͆y̺͆o̺͆😎")	
		...
		print wait["inviteprotect"]
	     ...
	     if msg.from_ in Creator:	 	        
		     wait["Ghost"] = True
		     iyo.sendText(msg.to,"Ghost Sudah Aktif")
	     else:
	        iyo.sendText(msg.to,"Khusus ☄i̺͆y̺͆o̺͆😎")		     
	     ...
	     if msg.from_ in Creator:	 	        
		     wait["Ghost"] = False
		     iyo.sendText(msg.to,"Ghost Sudah Di Nonaktifkan")
	     else:
	         iyo.sendText(msg.to,"Khusus ☄i̺͆y̺͆o̺͆😎")		     
		...
		if msg.from_ in Creator:	 	        
            ...
            elif msg.text in ["Copybycontact"]:
                wait["copy"] = True
                iyo.sendText(msg.to,"Send Contact")


            elif msg.text in ["Publik off"]:
                wait["Bot"] = False
                iyo.sendText(msg.to,"Bote wis modar bose....")   
		...
		if midd not in admin:
		    ...
		    iyo.sendText(msg.to,"Admin Detected")
                ...
                midd = "u49f93172b8c8865683dd2d47ccbb8613"
                iyo.inviteIntoGroup(msg.to,[midd])
		...
		if msg.from_ in Creator:
		    for i in gid:
			iyo.sendText(i,"=======[BROADCAST]=======\n\n"+bc+"\n\nContact Me : line.me/ti/p/~ri_her")
		...
		iyo.sendText(msg.to, "Progress...")
                iyo.sendText(msg.to, "%sseconds" % (elapsed_time))
  ...
  #                                  except Exception as e:
   #                                     iyo.sendText(msg.to,str(e))
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                ...
                if msg.from_ in Creator:
                    path = "iyo.jpg"
                    iyo.sendText(msg.to,"Send Gambarnya:")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                #link = ["http://dl.profile.line-cdn.net/" + h.pictureStatus]
                   ...
                   if txt[1] == "on":
                        if jmlh <= 10:
                             for x in range(jmlh):
                               ...
                               iyo.sendText(msg.to, "ke akehan cok! ")
                   elif txt[1] == "off":
                         if jmlh <= 10:
                ...
                try:
                    ...
                    iyo.sendImageWithURL(msg.to, text1[0])
                ...
                iyo.sendAudio(msg.to,"hasil.mp3")
                    ...
                    beb = "Hay jg beb 😘 " +iyo.getContact(msg.from_).displayName + " 􀸂􀆇starry heart􏿿"
		...
		if msg.from_ in Creator:
                ...
                wait["Bot"] = False
                iyo.sendText(msg.to,"Bote wis m0diar bos...")   
                
                 
            elif "Ramalan " in msg.text:
                tanggal = msg.text.replace("Ramalan ","")
                ...
                if msg.from_ in Creator:
                    ...
                    for i in gid:
                        if i is not None:
                            ...
                            break
                    if gid is not None:
                        iyo.sendText(msg.to,"wis tak trimo kabeh bos, undangan sing mandek :\n" + _list)
                    else:
                        iyo.sendText(msg.to,"ora enek undangan bose..")  
